...
void SceneGarage::InitDerived()
{
	...
	//init objects
	TAXI.Init("Taxi","OBJ//TAXI.obj", "Image//Green.tga", Vector3(0, 0, 0), Vector3(0, 0, 0), Vector3(0.1f, 0.1f, 0.1f));
...
void SceneGarage::UpdateDerived(double dt)  //Keeps the vehicles in rotation
{
	...
	if (currentVehicle == 0)
	{
		...
		{
			TAXI.IncrementScale(Vector3(0.03f, 0.03f, 0.03f));
		}
	}
	else if (currentVehicle != 0)
	{
		TAXI.SetScale(Vector3(0.1f, 0.1f, 0.1f));
	}
	...
	if (currentVehicle == 1)
	{
		...
		{
			TRUCK.IncrementScale(Vector3(0.03f, 0.03f, 0.03f));
		}
	}
	else if (currentVehicle != 1)
	{
		TRUCK.SetScale(Vector3(0.1f, 0.1f, 0.1f));
	}
	...
	if (currentVehicle == 2)
	{
		...
		{
			F1.IncrementScale(Vector3(0.03f, 0.03f, 0.03f));
		}
	}
	else if (currentVehicle != 2)
	{
		F1.SetScale(Vector3(0.1f, 0.1f, 0.1f));
	}
