...
{
	//get currentCursorXY
	currentCursorXY = Vector3((float)Application::cursorX, (float)Application::cursorY, 0);
...
{
	prevCursorXY = currentCursorXY = (Vector3((float)Application::cursorX, (float)Application::cursorY, 0));
}
