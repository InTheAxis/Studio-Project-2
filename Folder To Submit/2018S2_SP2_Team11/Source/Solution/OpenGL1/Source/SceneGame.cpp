...
void SceneGame::InitDerived()
{
	...
	//speedometer
	needle.Init("Needle", "OBJ//Needle.obj", "Image//Red.tga", Vector3(50, 1, 0), Vector3(-3, 0, 0), Vector3(1.5f, 1.6f, 1));
	...
	ai.SetStats(20000, 1111, 7000, 0.05f);
	ai.Reset();
	...
	car->SetStats(20000, 1111, 7000, 0.05f);
	...
	rightWall.SetTranslate(Vector3(53.75f, 0, 0));
	rightWall.SetRotate(Vector3(0, 180, 0));
	rightWall.SetScale(Vector3(1.1f, 0.5f, 1.1f));
	...
	backWall.SetTranslate(Vector3(0, 0, -53.75f));
	backWall.SetRotate(Vector3(0, 270, 0));
	backWall.SetScale(Vector3(1.1f, 0.5f, 1.1f));
